      ...
      _createClass(RegExpCreator, [
        {
          ...
          value: function create(str) {
            ...
            return new RegExp(
              str,
              "gm".concat(this.opt.caseSensitive ? "" : "i")
            );
          },
        },
        {
          ...
          value: function createSynonymsRegExp(str) {
            ...
            for (var index in syn) {
              if (syn.hasOwnProperty(index)) {
                var keys = Array.isArray(syn[index])
                  ? syn[index]
                  : [syn[index]];
                keys.unshift(index);
        ...
        },
        {
          ...
          value: function createJoinersRegExp(str) {
            ...
            return joiner.length
              ? str.split(/\u0000+/).join("[".concat(joiner.join(""), "]*"))
              : str;
          },
        },
        {
      ...
      _createClass(Mark, [
          ...
          value: function checkRanges(array) {
            ...
            array
              ...
              .forEach(function (item) {
                var _this2$callNoMatchOnI = _this2.callNoMatchOnInvalidRanges(
                    item,
                    last
                  ),
              ...
              if (
                ...
                this.log(
                  "Ignoring invalid or overlapping range: " +
                    "".concat(JSON.stringify(range))
                );
                this.opt.noMatch(range);
              }
            } else {
              this.log(
                "Ignoring invalid range: ".concat(JSON.stringify(range))
              );
              this.opt.noMatch(range);
            }
        ...
        },
        {
          ...
          value: function checkWhitespaceRanges(range, originalLength, string) {
            ...
            if (end > max) {
              ...
              this.log(
                "End range automatically set to the max value of ".concat(max)
              );
            }
        ...
        },
        {
          ...
          value: function mark(sv, opt) {
            ...
            var _this$getSeparatedKey = this.getSeparatedKeywords(
