!(function () {
    ...
    function E() {
        ...
        (!(a = document
            ...
            Array.from(
                ...
                document.querySelector(".ri-menu-fill") &&
    ...
    function v() {
        ...
        if (e < 1025 && e > 767) {
            ...
            if (document.querySelector(".ri-menu-fill")) {
                if (sidebarSize === "lg") {
                    document.querySelector(".ri-menu-fill").classList.add("open");
        ...
        // Adicionar eventos de clique e mouseover para itens de navegação
        const navbarItems = document.querySelectorAll("#navbar-nav > li.nav-item");
        navbarItems.forEach(function (item) {
            item.addEventListener("click", S.bind(this), false);
            item.addEventListener("mouseover", S.bind(this), false);
        });

        // Adicionar transições suaves aos elementos
        if (e > 767) {
            const elements = document.querySelectorAll(
                ".vertical-overlay, .vertical-sidebar-enable, .data-sidebar-size, .twocolumn-panel, #page-topbar, #topnav-hamburger-icon, .footer, .nao-veterano, .menu, .ri-menu-fill"
            );
    ...
    function I() {
        document.addEventListener("DOMContentLoaded", function () {
            const codeSwitchers = document.querySelectorAll(".code-switcher");

            codeSwitchers.forEach((switcher) => {
                switcher.addEventListener("change", function () {
                    const card = switcher.closest(".card");
                    const livePreview = card.querySelector(".live-preview");
        ...
        window.addEventListener("load", function () {
            ...
            const overlayElements = document.querySelectorAll(".vertical-overlay");
            ...
            overlayElements.forEach((overlay) => {
                overlay.addEventListener("click", function () {
                    ...
                    if (layout === "twocolumn") {
                        ...
                        const sidebarSize = sessionStorage.getItem("data-sidebar-size") || "sm";
        ...
        const homeIcon = document.getElementById("topnav-home-icon");

        if (hamburgerIcon) {
            hamburgerIcon.addEventListener("click", w);
        }

        if (homeIcon) {
            homeIcon.addEventListener("click", w);
        }

        const defaultAttribute = sessionStorage.getItem("defaultAttribute");
        if (defaultAttribute) {
            const layoutData = JSON.parse(defaultAttribute);
            if (layoutData["data-layout"] === "twocolumn" && window.innerWidth < 767) {
                const menuItems = document.querySelectorAll("#two-column-menu li");
    ...
    function x(e) {
        if (e == e) {
            ...
            switch (localStorage.getItem("data-layout-mode") || sessionStorage.getItem("data-layout-mode") || "light") {
                case "light":
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        : ((i = document.documentElement.attributes),
            ...
            //screenWidth < 1024 ? a["data-sidebar-size"] = 'sm' : 'lg',
            x(a),
