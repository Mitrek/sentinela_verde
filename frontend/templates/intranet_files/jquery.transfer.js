...
(function ($) {
  var Transfer = function (element, options) {
    ...
    this.defaults = {
      ...
      tabNameText: "Atalhos",
      // right tab text
      rightTabNameText: "Atalhos selecionados",
                        ...
                        <div class="transfer-double-selected-list">                      
                            ...
                            <div class="transfer-double-list-footer">
                                <div class="checkbox-group">
                                    <input type="checkbox" class="checkbox-normal ola10" id="rightItemSelectAll_{{= self.id }}">
    ...
    var template = parseHTMLTemplate(function () {
      /*
            <div class="transfer-double-list transfer-double-list-{{= self.id }}">
                ...
                <div class="transfer-double-list-footer">
                    <div class="checkbox-group">
                        <input type="checkbox" class="checkbox-normal ola8" id="groupItemSelectAll_{{= self.id }}"><label for="groupItemSelectAll_{{= self.id }}" class="group_total_num_{{= self.id }}"></label>
                    </div>
                </div>
            </div>
            */
    ...
    var template = parseHTMLTemplate(function () {
      /*
            <div class="transfer-double-list transfer-double-list-{{= self.id }}">
                ...
                <div class="transfer-double-list-footer">
                    <div class="checkbox-group">
                        <input type="checkbox" class="checkbox-normal ola7" id="leftItemSelectAll_{{= self.id }}"><label for="leftItemSelectAll_{{= self.id }}" class="total_num_{{= self.id }}"></label>
                    </div>
                </div>
            </div>
           */
    ...
    var template = parseHTMLTemplate(function () {
      /*
            <li class="transfer-double-list-li transfer-double-list-li-{{= self.id }} {{= selected ? 'selected-hidden' : ' ' }}">
                <div class="checkbox-group">
                    <input {{= disabled ? disabled="disabled" : "" }} type="checkbox" value="{{= dataArray[i][valueName] }}" class="checkbox-normal ola6 checkbox-item-{{= self.id }}" id="itemCheckbox_{{= i }}_{{= self.id }}">
    ...
    var groupItemTemplate = parseHTMLTemplate(function () {
      /*
            <li class="transfer-double-group-list-li-ul-li transfer-double-group-list-li-ul-li-{{= self.id }} {{= selected ? 'selected-hidden' : '' }}">
                <div class="checkbox-group">
                    <input type="checkbox" value="{{= groupDataArray[i][groupArrayName][j][valueName] }}" class="checkbox-normal itemAtalho itemAtalho_{{= groupDataArray[i][groupArrayName][j][valueName] }} ola4 group-checkbox-item-{{= self.id }} belongs-group-{{= i }}-{{= self.id }}" id="group_{{= i }}_checkbox_{{= j }}_{{= self.id }}">
    ...
    var groupTemplate = parseHTMLTemplate(function () {
      /*
            <li class="transfer-double-group-list-li transfer-double-group-list-li-{{= self.id }}">
                <div class="checkbox-group">
                    <input type="checkbox" class="checkbox-normal itemGrupoAtalho ola3 group-select-all-{{= self.id }}" id="group_{{= i }}_{{= self.id }}">
    ...
    var template = parseHTMLTemplate(function () {
      /*
            <li class="transfer-double-selected-list-li  transfer-double-selected-list-li-{{= id }} .clearfix">
                <div class="checkbox-group">
                    <input {{= disabled ? disabled="disabled" : " " }} type="checkbox" value="{{= value }}" class="checkbox-normal ola2 checkbox-selected-item-{{= id }}" id="selectedCheckbox_{{= index }}_{{= id }}">
  ...
  Transfer.prototype.generate_group_item = function (
    ...
    var template = parseHTMLTemplate(function () {
      /*
            <li class="transfer-double-selected-list-li transfer-double-selected-list-li-{{= id }} .clearfix">
                <div class="checkbox-group">
                    <input type="checkbox" value="{{= value }}" class="checkbox-normal itemAtalho itemAtalho_{{= value }} itemAtalhoSelecionado itemAtalhoSelecionado_{{= value }} ola1 checkbox-selected-item-{{= id }}" id="group_{{= groupIndex }}_selectedCheckbox_{{= itemIndex }}_{{= id }}">
